...
const Home = ({ navigation }) => {
    ...
    const RenderHeader =() =>{
        return (
            <View style={{ flexDirection: 'row',paddingVertical:SIZES.paddingText*3,justifyContent:'space-between', paddingHorizontal:SIZES.padding,height: 80,backgroundColor:COLORS.white,marginTop:Platform.OS === "web"?0:10 }}>
                <TouchableOpacity
                    style={{
