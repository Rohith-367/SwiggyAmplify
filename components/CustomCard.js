        ...
        >
            <View style={styles.cont}>
                ...
                <View style={{paddingHorizontal:SIZES.paddingText*3}}>
                    ...
                    <View style={{display:'flex',flexDirection:"row",paddingBottom:SIZES.paddingText1}}>
                        <Icon 
                            name="star" 
                            size={14} 
                            style={{
                    ...
                    />
                    <View style={{display:'flex',flexDirection:"row",paddingTop:SIZES.padding}}>
                        <Image
                        ...
                        />
                        <Text style={{fontSize:SIZES.body4,paddingLeft:10,paddingTop:3}}>Use SWIGGYIT</Text>
                    </View>
